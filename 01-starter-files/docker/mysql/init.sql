-- -----------------------------------------------------
-- Init script for Docker: full-stack-ecommerce
-- -----------------------------------------------------
...
-- 2️⃣ Desactivar FK temporalmente
SET FOREIGN_KEY_CHECKS = 0;

-- Crear tablas sin dependencias externas
...
-- Tabla product (depende de product_category)
...
(1,'BR','Brazil'), (2,'CA','Canada'), (3,'DE','Germany'), (4,'IN','India'),
(5,'TR','Turkey'), (6,'US','United States'), (7,'ES','Spain');
...
(222,'Yozgat',5),
(223,'Zonguldak',5),
(224,'Álava',7),(225,'Albacete',7),(226,'Alicante',7),(227,'Almería',7),(228,'Asturias',7),
(229,'Ávila',7),(230,'Badajoz',7),(231,'Barcelona',7),(232,'Burgos',7),(233,'Cáceres',7),
(234,'Cádiz',7),(235,'Cantabria',7),(236,'Castellón',7),(237,'Ciudad Real',7),(238,'Córdoba',7),
(239,'La Coruña',7),(240,'Cuenca',7),(241,'Gerona',7),(242,'Granada',7),(243,'Guadalajara',7),
(244,'Guipúzcoa',7),(245,'Huelva',7),(246,'Huesca',7),(247,'Islas Baleares',7),(248,'Jaén',7),
(249,'León',7),(250,'Lérida',7),(251,'Lugo',7),(252,'Madrid',7),(253,'Málaga',7),
(254,'Murcia',7),(255,'Navarra',7),(256,'Orense',7),(257,'Palencia',7),(258,'Las Palmas',7),
(259,'Pontevedra',7),(260,'La Rioja',7),(261,'Salamanca',7),(262,'Santa Cruz de Tenerife',7),
(263,'Segovia',7),(264,'Sevilla',7),(265,'Soria',7),(266,'Tarragona',7),(267,'Teruel',7),
(268,'Toledo',7),(269,'Valencia',7),(270,'Valladolid',7),(271,'Vizcaya',7),(272,'Zamora',7),
(273,'Zaragoza',7);
...
UPDATE product
SET image_url = CONCAT('/images/products', SUBSTRING(image_url, LENGTH('assets/images/products') + 1));
